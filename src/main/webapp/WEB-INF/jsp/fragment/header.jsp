...
<%--     <link href="<pwm:url url='/public/resources/style.css' addContext="true"/>" rel="stylesheet" type="text/css" media="screen"/>
   ...
   <pwm:if test="<%=PwmIfTest.requestFlag%>" requestFlag="<%=PwmRequestFlag.NO_MOBILE_CSS%>" negate="true">
    ...
    <link href="<pwm:url url='/public/resources/css/bootstrap.min.css' addContext="true"/>" rel="stylesheet" type="text/css" media="screen"/>
    <link href="<pwm:url url='/public/resources/css/custom-style.css' addContext="true"/>" rel="stylesheet" type="text/css" media="screen"/>
    <pwm:script-ref url="/public/resources/bootstrapjs/bootstrap.min.js"/>
    <pwm:script>

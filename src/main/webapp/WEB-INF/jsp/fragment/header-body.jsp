...
<!-- <div class="bg-inverse collapse" id="navbarHeader" aria-expanded="false" style="">
    ...
    <div class="navbar navbar-inverse bg-inverse">
      <div>
      <img src="/pwm/public/resources/LogoWhiteRightFinal.png" class="hs-image-widget " style="width:150px;border-width:0px;border:0px;"/>
        <!-- <a href="#" class="navbar-brand">Paranet</a> -->
      </div>
    </div>
<%-- <div id="header">
    <div id="header-company-logo">
    <img src="/pwm/public/resources/LogoWhiteRightFinal.png" class="hs-image-widget " style="width:100px;border-width:0px;border:0px;" width="100"/>
    </div>

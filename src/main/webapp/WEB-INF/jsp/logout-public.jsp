...
<div id="wrapper">
    ...
    <div id="centerbody">
        <div id="page-content-title" class="text-white"><pwm:display key="Title_LogoutPublic" displayIfMissing="true"/></div>
        <%@ include file="fragment/message.jsp" %>
        <p class="text-white"><pwm:display key="Display_LogoutPublic"/></p>
        <br/>
        <br/>
        <p>
